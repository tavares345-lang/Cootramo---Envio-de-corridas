...
const LoginView: React.FC<LoginViewProps> = ({ onLogin }) => {
  ...
  const [view, setView] = useState<'driver' | 'super'>('driver');
        ...
        <div className="bg-slate-800 rounded-lg shadow-lg p-8">
          {view === 'driver' ? (
            ...
            <form onSubmit={handleAdminLogin}>
                ...
                <button
                  type="submit"
                  className="w-full bg-sky-500 hover:bg-sky-600 text-white font-bold py-3 px-4 rounded-md transition duration-300 flex items-center justify-center gap-2 mb-4 shadow-lg"
                >
